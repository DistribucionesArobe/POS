...
def obtener_cotizacion(
    ...
    return {
        ...
        "empresa_razon_social": emp.razon_social if emp else "",
        "empresa_rfc": emp.rfc if emp else "",
        "empresa_regimen": emp.regimen_fiscal if emp else "",
        "empresa_cp": emp.codigo_postal if emp else "",
